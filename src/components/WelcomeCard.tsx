...
function CarouselNav() {
  return (
    <div className="absolute left-6 bottom-6">
      <div className="z-[100] w-[531px] h-[277px] p-6 bg-white bg-opacity-70 rounded-2xl border-4 border-white border-opacity-10 backdrop-blur-2xl flex-col justify-start items-start gap-8 inline-flex">
